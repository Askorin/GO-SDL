...
void render_game_state(int, int[19][19], SDL_Renderer*, SDL_Texture*[OBJ_QTY], SDL_Rect*, button_t*[2]);
...
void render_game_ui(SDL_Renderer*, SDL_Texture*[OBJ_QTY], button_t*[2]);
